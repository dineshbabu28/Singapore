...
data = pd.read_csv(r"C:\Users\venugdi\Downloads\mrt.csv")
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                with open(r"C:\Users\venugdi\Downloads\scaler (1).pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r"C:\Users\venugdi\Downloads\scaler (1).pkl", 'rb') as f:
                ...
                data = pd.read_csv(r"C:\Users\venugdi\Downloads\df_coordinates.csv")
